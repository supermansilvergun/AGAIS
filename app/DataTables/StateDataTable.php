    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function($state){
                $btn = '
                    <div class="btn-group">
                        <a href="'.route('states.edit', $state).'" type="button" class="btn btn-primary btn-edit" title="'.__('Edit').'"><i class="fa fa-edit"></i></a>
                        <a href="'.route('states.show', $state).'" type="button" class="btn btn-primary btn-show" data-toggle="modal" data-target="#modal-show"  title="'.__('Details').'"><i class="fa fa-eye"></i></a>
                        <a href="'.route('states.destroy', $state).'"  type="button" class="btn btn-primary btn-delete" title="'.__('Delete').'"><i class="fa fa-trash"></i></a>
                    </div>';
                return $btn;
            })
            ->addColumn('select', function($state){
                    $checkbox = '<input type="checkbox" class="sub_check" data-route="'.route('states.purge', $state->id).'" data-id="'.$state->id.'">';
                    return $checkbox;
                })
